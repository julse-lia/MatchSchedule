                        ...
                        <tbody>
                            ...
                            <c:forEach var="team" items="${listTeam}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="detail?id=<c:out value='${team.id}' />"> <c:out value="${team.teamname}" /> </a>
                                    </td>
                                    <td>
                                    ...
                                    <td><a href="edit?id=<c:out value='${team.id}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp; 
                                        <a href="delete?id=<c:out value='${team.id}' />">Delete</a></td>
                                </tr>
                            </c:forEach>
                            <!-- } -->
                        </tbody>
